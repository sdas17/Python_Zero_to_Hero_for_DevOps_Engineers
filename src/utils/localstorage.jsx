...
export const getLocalStorage = () => {
  const employee_data = JSON.stringify(localStorage.getItem("employee"));
  const admin_data =JSON.stringify( localStorage.getItem("admin"));

  console.log(
    JSON.parse(employee_data), 
    JSON.parse(admin_data)
  );
};
